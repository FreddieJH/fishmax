...
Installation of fishmax also requires `cmdstan` to be installed. You can install cmdstan directly from R using `cmdstanr::install_cmdstan()`. To install cmdstanr, cmdstan and fishmax:
