...
Once you have installed the cmdstanr package, cmdstan software, and the fishmax package, you can load it.
...
To check whether the models have converged, we inspect the MCMC traceplots. These show whether the chains mix well and explore the posterior without drift. 
